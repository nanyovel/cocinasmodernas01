        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex ">
            ...
            <div className="md:col-span-2">
              <div className="font-display text-3xl font-light text-gold tracking-widest mb-1">
                COCINAS
              </div>
              <div className="font-body text-xs tracking-[0.5em] text-cream/40 uppercase mb-6">
                Modernas RD
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm text-cream/50">
              <li>
                📍Av. Sarasota esquina Av. Enrique Jimenez Moya, Plaza
                Universitaria, ala Oeste, Segundo Nivel, Santo Domingo, RD
              </li>
              <li>
                <a
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 font-body text-xs text-cream/30">
          ...
          {/* <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:text-[#c9a84c] transition-colors duration-300"
            >
              Noarix
            </a>{" "}
          </p> */}
