...
const galleryImages = [
  ...
  },
  {
    ...
    alt: 'Cocina moderna oscura con muebles de cocina y electrodomésticos premium',
    label: 'Cocina Moderna Oscura',
  },
  {
    src: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80',
    alt: 'Cocina moderna abierta con isla y desayunador en RD',
    label: 'Cocina Abierta con Isla',
  },
]
...
const features = [
  ...
  },
  {
    ...
    desc: 'Gabinetes de cocina modernos en PVC, melamina o madera. Muebles de cocina modernos con materiales de primera importación.',
  },
  {
    icon: '◎',
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-32 pb-20 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="font-display text-5xl md:text-7xl font-light leading-[1.05] text-cream mb-6">
              Tu cocina moderna,{' '}
              <span className="text-shimmer italic">obra maestra</span>{' '}
              de diseño
            </h1>
            <p className="font-body text-base text-cream/60 leading-relaxed max-w-lg mb-10">
              Diseñamos y fabricamos <strong className="text-cream/80">cocinas modernas</strong> a medida en Santo Domingo y todo el país. 
              Gabinetes modernos, islas de cocina, muebles de cocina y acabados de lujo. 
              Cocinas modernas con isla, en L, lineales o americanas — todas a tu medida.
            </p>
            ...
            <div className="flex gap-10 mt-14 pt-10 border-t border-gold/15">
              {[
                ...
                <div key={s.label}>
                  ...
                  <div className="font-body text-xs text-cream/40 uppercase tracking-widest mt-1">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="section-pad bg-obsidian-soft relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="font-body text-xs tracking-[0.4em] uppercase text-gold mb-4">Por qué elegirnos</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((f, i) => (
              ...
              >
                ...
                <p className="font-body text-sm text-cream/50 leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-pad">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              <p className="font-body text-xs tracking-[0.4em] uppercase text-gold mb-4">Nuestros proyectos</p>
              <h2 className="font-display text-4xl md:text-5xl font-light text-cream">
                Diseños de cocinas modernas realizados
              </h2>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {galleryImages.map((img, i) => (
              <div key={i} className="luxury-card relative overflow-hidden aspect-[3/4] group">
                <Image
                  src={img.src}
                  alt={img.alt}
                  fill
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <p className="font-body text-xs tracking-widest uppercase text-gold">{img.label}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="section-pad bg-obsidian-soft">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="font-body text-xs tracking-[0.4em] uppercase text-gold mb-4">Testimonios</p>
            <h2 className="font-display text-4xl md:text-5xl font-light text-cream">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="luxury-card border border-gold/10 bg-obsidian p-8">
                ...
                <p className="font-body text-xs text-gold/60 tracking-wider">{t.location}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <p className="font-body text-xs tracking-[0.4em] uppercase text-gold mb-6">Empieza hoy</p>
          ...
          <p className="font-body text-base text-cream/60 mb-4">
            Agenda una consulta gratuita y recibe el diseño preliminar de tu cocina moderna sin costo ni compromiso.
          </p>
          <p className="font-body text-sm text-cream/40 mb-10">
            Cocinas modernas con isla · Gabinetes modernos · Cocinas modernas pequeñas · Cocinas de madera modernas · Cocinas modernas blancas · Cocinas modernas con barra
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/18091234567?text=Hola,%20quiero%20información%20sobre%20cocinas%20modernas"
              target="_blank"
      ...
      <section className="py-16 px-6 bg-obsidian-soft border-t border-gold/10">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-10">
            <div>
              <h3 className="font-display text-xl text-gold mb-4">Cocinas Modernas con Isla</h3>
              <p className="font-body text-xs text-cream/40 leading-relaxed">
                Diseñamos cocinas modernas con isla central, cocinas modernas con isla y desayunador, 
                cocinas con isla pequeña, cocinas modernas con barra americana y cocinas modernas con 
                península. Islas de cocina en granito, cuarzo o mármol a medida en Santo Domingo.
              </p>
            </div>
            <div>
              <h3 className="font-display text-xl text-gold mb-4">Gabinetes y Muebles de Cocina</h3>
              <p className="font-body text-xs text-cream/40 leading-relaxed">
                Fabricamos gabinetes de cocina modernos en madera, PVC, melamina y MDF. 
                Muebles de cocina modernos blancos, grises, oscuros o de madera. 
                Gabinetes modernos para cocinas pequeñas, medianas y grandes en toda la República Dominicana.
              </p>
            </div>
            <div>
              <h3 className="font-display text-xl text-gold mb-4">Diseños y Modelos de Cocinas</h3>
              <p className="font-body text-xs text-cream/40 leading-relaxed">
                Modelos de cocinas modernas en L, cocinas lineales, cocinas en U, cocinas americanas 
                modernas y cocinas abiertas. Cocinas modernas blancas, cocinas negras modernas, 
                cocinas de madera modernas y cocinas modernas de lujo en República Dominicana.
              </p>
            </div>
          </div>
        </div>
