...
export const metadata: Metadata = {
  title: 'Contacto | Cotización Gratis de Cocinas Modernas con Isla, Gabinetes y Muebles en RD',
  description:
  ...
  return (
    <>
      ...
      <section className="pt-36 pb-20 px-6 bg-obsidian-soft text-center relative">
        ...
        <p className="font-body text-xs tracking-[0.4em] uppercase text-gold mb-4">Hablemos</p>
        ...
        <p className="font-body text-base text-cream/50 max-w-2xl mx-auto">
          Cocinas modernas con isla, gabinetes de cocina modernos, muebles de cocina y más. 
          Sin compromiso, sin costo. Cuéntanos tu proyecto y te respondemos en menos de 24 horas 
          ...
          <div className="space-y-8 lg:pt-4">
            ...
            {contactInfo.map((c, i) => (
              <div key={i} className="flex gap-6 group">
                ...
                <div>
                  <p className="font-body text-xs tracking-widest uppercase text-gold mb-1">{c.label}</p>
                  {c.href ? (
                    <a href={c.href} className="font-display text-xl text-cream hover:text-gold transition-colors">
                      {c.value}
                    </a>
                  ) : (
                    <p className="font-display text-xl text-cream">{c.value}</p>
                  )}
                  <p className="font-body text-xs text-cream/40 mt-1">{c.sub}</p>
                </div>
              </div>
            ))}
            ...
            <div className="mt-10 p-8 border border-gold/20 bg-obsidian-soft">
              ...
              <a
                href="https://wa.me/18091234567?text=Hola,%20me%20interesa%20una%20cotización%20de%20cocina%20moderna"
                target="_blank"
