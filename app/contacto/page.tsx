...
const PAGE_TITLE = "Contacto | Cotización Gratis - Cocinas Modernas RD";
const PAGE_DESCRIPTION =
  "Solicita tu cotización gratuita de cocina moderna en Santo Domingo y toda República Dominicana. Respondemos en menos de 24 horas.";
const PAGE_URL = "https://cocinasmodernasrd.com/contacto";
    ...
    <>
      ...
      <section className="pt-36 pb-20 px-6 bg-obsidian-soft text-center relative">
        ...
        <p className="font-body text-base text-cream/50 max-w-2xl mx-auto">
          Sin compromiso, sin costo. Cuéntanos tu proyecto y te respondemos en
          menos de 24 horas con un presupuesto personalizado.
        </p>
      </section>
