...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Fabricamos cocinas de madera modernas a medida en República Dominicana. Cedro, caoba, teca y más.',
    images: [{ url: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=1200&q=80' }],
  },
}
...
const data: CocinaPageData = {
  ...
  metaDescription: 'Cocinas de madera modernas a medida en República Dominicana.',

  heroImage: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=1800&q=85',
  heroImageAlt: 'Cocina de madera moderna con gabinetes de cedro en República Dominicana',
  ...
  features: [
    { icon: '🌳', title: 'Madera seleccionada', desc: 'Cedro, caoba, teca y roble. Cada tabla es seleccionada a mano para garantizar calidad y uniformidad.' },
    { icon: '◉', title: 'Tratamiento tropical', desc: 'Tratamiento especial contra humedad e insectos, diseñado para el clima de República Dominicana.' },
    { icon: '◎', title: 'Diseños contemporáneos', desc: 'La madera no tiene que verse rústica. Nuestros diseños son modernos, limpios y sofisticados.' },
    { icon: '◈', title: 'Durabilidad generacional', desc: 'Una cocina de madera bien fabricada dura décadas y puede restaurarse múltiples veces.' },
  ],

  gallery: [
    { src: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=800&q=80', alt: 'Cocina de madera moderna con acabado natural en RD', label: 'Madera natural' },
    { src: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80', alt: 'Cocina moderna madera y blanco con isla', label: 'Madera y blanco' },
    { src: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80', alt: 'Cocina de madera oscura con gabinetes de caoba', label: 'Caoba oscura' },
    { src: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=800&q=80', alt: 'Cocina de madera clara nórdica con encimera de cuarzo', label: 'Madera clara nórdica' },
    { src: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&q=80', alt: 'Muebles de cocina en madera con detalles dorados', label: 'Madera y detalles oro' },
  ],
  ...
  waMessage: 'Hola, me interesa una cotización de cocina de madera moderna. ¿Qué tipos de madera manejan?',
}
