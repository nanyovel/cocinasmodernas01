...
export const metadata: Metadata = {
  title: 'Cocinas Vintage Modernas en República Dominicana | Estilo Retro de Lujo',
  description:
  ...
  alternates: { canonical: 'https://www.cocinasmodernasrd.com/cocinas/vintage' },
  openGraph: {
    title: 'Cocinas Vintage Modernas RD | Retro con Toque Contemporáneo',
    description: 'Cocinas vintage modernas en República Dominicana. Diseños retro con materiales contemporáneos de lujo.',
    images: [{ url: 'https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=1200&q=80' }],
  },
}
...
const data: CocinaPageData = {
  ...
  metaDescription: 'Cocinas vintage modernas en República Dominicana. Estilo retro con acabados premium.',

  heroImage: 'https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=1800&q=85',
  heroImageAlt: 'Cocina vintage moderna con gabinetes retro y detalles en madera en República Dominicana',
  ...
  features: [
    { icon: '🕰️', title: 'Carácter único', desc: 'Las cocinas vintage tienen personalidad propia. Ningún proyecto es igual, cada uno cuenta una historia.' },
    { icon: '◉', title: 'Herrajes especiales', desc: 'Manijas, jaladores y accesorios en cobre, bronce o hierro forjado para autenticidad al detalle.' },
    { icon: '◎', title: 'Azulejos y talavera', desc: 'Usamos mayólicas, talavera y azulejos hidráulicos que dan identidad y carácter al diseño.' },
    { icon: '◈', title: 'Materiales duraderos', desc: 'Pese al estilo clásico, usamos materiales modernos de alta durabilidad bajo una apariencia vintage.' },
  ],

  gallery: [
    { src: 'https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=800&q=80', alt: 'Cocina vintage moderna con gabinetes de madera y azulejos de talavera', label: 'Vintage con talavera' },
    { src: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=800&q=80', alt: 'Cocina vintage blanca con herrajes en bronce y mayólicas', label: 'Vintage blanco y bronce' },
    { src: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80', alt: 'Cocina retro moderna con mármol envejecido y madera oscura', label: 'Retro con mármol' },
    { src: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80', alt: 'Cocina vintage abierta con detalles en hierro forjado', label: 'Vintage con hierro forjado' },
    { src: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=800&q=80', alt: 'Cocina vintage farmhouse con gabinetes crema y encimera de granito', label: 'Farmhouse vintage' },
  ],
  ...
  waMessage: 'Hola, me interesa una cocina estilo vintage moderno. ¿Pueden mostrarme ejemplos de proyectos realizados?',
}
