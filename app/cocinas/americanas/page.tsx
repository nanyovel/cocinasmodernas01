...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.cocinasmodernasrd.com/cocinas/americanas' },
  openGraph: {
    title: 'Cocinas Americanas RD | Open Concept Integrado con Sala',
    description: 'Cocinas americanas modernas en República Dominicana. Open concept, barra americana e isla integrada.',
...
const data: CocinaPageData = {
  ...
  metaDescription: 'Cocinas americanas modernas open concept en República Dominicana.',

  heroImage: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=1800&q=85',
  heroImageAlt: 'Cocina americana moderna open concept integrada con sala y comedor en República Dominicana',
  ...
  features: [
    { icon: '🏡', title: 'Espacios más amplios', desc: 'Al eliminar paredes, los espacios se perciben hasta un 40% más grandes y luminosos.' },
    { icon: '◉', title: 'Integración social', desc: 'Cocinas, sala y comedor conectados. Cocinas mientras convives con tu familia y tus invitados.' },
    { icon: '◎', title: 'Barra americana', desc: 'La barra divide los espacios elegantemente, sirve de desayunador y da dinamismo al diseño.' },
    { icon: '◈', title: 'Extracción premium', desc: 'Instalamos campanas extractoras de alto rendimiento para mantener el área social sin olores.' },
  ],

  gallery: [
    { src: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80', alt: 'Cocina americana moderna open concept con sala integrada en RD', label: 'Open concept con sala' },
    { src: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80', alt: 'Cocina americana con isla y barra desayunador', label: 'Barra americana con isla' },
    { src: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=800&q=80', alt: 'Cocina americana blanca integrada con comedor moderno', label: 'Cocina americana blanca' },
    { src: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&q=80', alt: 'Cocina americana oscura con barra y penthouse', label: 'Cocina americana de lujo' },
    { src: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=800&q=80', alt: 'Cocina americana en madera con sala de estar integrada', label: 'Madera y sala integrada' },
  ],
  ...
  waMessage: 'Hola, me interesa una cocina americana moderna. ¿Pueden asesorarme sobre el diseño open concept?',
}
