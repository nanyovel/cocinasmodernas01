...
export const metadata: Metadata = {
  title: 'Cocinas con Barra Desayunador en República Dominicana | Diseño Moderno',
  description:
  ...
  alternates: { canonical: 'https://www.cocinasmodernasrd.com/cocinas/barra-desayunador' },
  openGraph: {
    title: 'Cocinas con Barra Desayunador RD | Granito, Cuarzo y Mármol',
    description: 'Cocinas con barra desayunador en República Dominicana. Barras a medida en granito, cuarzo y mármol.',
    images: [{ url: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=1200&q=80' }],
  },
}
...
const data: CocinaPageData = {
  ...
  metaDescription: 'Cocinas con barra desayunador en República Dominicana. Barras a medida en granito, cuarzo y mármol.',

  heroImage: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=1800&q=85',
  heroImageAlt: 'Cocina moderna con barra desayunador integrada en granito en Santo Domingo República Dominicana',
  ...
  features: [
    { icon: '☕', title: 'Zona de desayuno', desc: 'Un espacio cómodo para desayunar sin ocupar el comedor. Ideal para el ritmo de vida diario dominicano.' },
    { icon: '◉', title: 'Superficie extra', desc: 'La barra duplica el espacio de trabajo disponible, muy útil al cocinar para eventos o reuniones.' },
    { icon: '◎', title: 'División elegante', desc: 'En cocinas abiertas, la barra divide cocina y sala de forma elegante sin necesitar paredes.' },
    { icon: '◈', title: 'Materiales premium', desc: 'Granito, cuarzo, mármol, madera o cemento pulido. La barra que dura y que siempre se ve bien.' },
  ],

  gallery: [
    { src: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80', alt: 'Cocina moderna con barra desayunador en granito y sillas altas', label: 'Barra con sillas altas' },
    { src: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80', alt: 'Cocina con isla y barra desayunador integrados en mármol', label: 'Isla con barra integrada' },
    { src: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=800&q=80', alt: 'Cocina blanca con barra americana en cuarzo blanco', label: 'Barra americana blanca' },
    { src: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&q=80', alt: 'Cocina oscura con barra desayunador en cemento pulido', label: 'Barra en cemento pulido' },
    { src: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=800&q=80', alt: 'Cocina en madera con barra desayunador de madera y cuarzo', label: 'Barra en madera y cuarzo' },
  ],
  ...
  waMessage: 'Hola, me interesa una cocina con barra desayunador. ¿Pueden asesorarme sobre diseño y materiales?',
}
