...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.cocinasmodernasrd.com/cocinas/elegantes' },
  openGraph: {
    title: 'Cocinas Elegantes de Lujo RD | Mármol, Cuarzo y Diseño Premium',
    description: 'Las cocinas más elegantes y lujosas de República Dominicana. Materiales premium y diseño exclusivo.',
...
const data: CocinaPageData = {
  ...
  metaDescription: 'Cocinas elegantes y de lujo en República Dominicana. Mármol, cuarzo y materiales premium.',

  heroImage: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1800&q=85',
  heroImageAlt: 'Cocina elegante de lujo con mármol blanco e isla central en Santo Domingo',
  ...
  features: [
    { icon: '💎', title: 'Mármol importado', desc: 'Calacatta, Carrara, Marquina y otras variedades seleccionadas directamente de cantera para tu proyecto.' },
    { icon: '◉', title: 'Accesorios europeos', desc: 'Herrajes Blum y Hettich con cierre suave en todos los gabinetes y cajones sin excepción.' },
    { icon: '◎', title: 'Iluminación de diseño', desc: 'LED integrado bajo gabinetes, iluminación de vitrina y lámparas colgantes de colecciones de diseño.' },
    { icon: '◈', title: 'Acabados únicos', desc: 'Lacados de alta brillo, texturas 3D, vidrio ahumado y acabados en metal satinado o cepillado.' },
  ],

  gallery: [
    { src: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80', alt: 'Cocina elegante de lujo con isla de mármol Calacatta en Santo Domingo', label: 'Mármol Calacatta' },
    { src: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=800&q=80', alt: 'Cocina elegante blanca lacada con detalles en oro y cuarzo', label: 'Lacado y oro' },
    { src: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&q=80', alt: 'Cocina lujosa oscura con isla negra y electrodomésticos integrados', label: 'Lujo en negro' },
    { src: 'https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=800&q=80', alt: 'Cocina elegante con gabinetes hasta el techo y vitrina iluminada', label: 'Vitrina iluminada' },
    { src: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80', alt: 'Cocina de lujo abierta con isla central y acabados premium', label: 'Lujo open concept' },
  ],
  ...
  waMessage: 'Hola, estoy buscando una cocina elegante de lujo. Me gustaría ver qué proyectos han realizado y cotizar el mío.',
}
