...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://cocinasmodernasrd.com/cocinas/italianas" },
  openGraph: {
    title: "Cocinas Italianas RD | Minimalismo y Lujo al Estilo Europeo",
    description:
      "Cocinas estilo italiano moderno en República Dominicana. Diseño europeo con materiales premium.",
    images: [
      {
...
const data: CocinaPageData = {
  ...
  metaDescription:
    "Cocinas estilo italiano modernas en República Dominicana. Diseño minimalista europeo de lujo.",

  heroImage:
    "https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=1800&q=85",
  heroImageAlt:
    "Cocina estilo italiano moderna minimalista con acabados premium en República Dominicana",
  ...
  features: [
    {
      icon: "🇮🇹",
      title: "Diseño sin manijas",
      desc: "Los sistemas push-to-open crean frentes completamente limpios, el sello del minimalismo italiano.",
    },
    {
      icon: "◉",
      title: "Superficies continuas",
      desc: "Encimeras que se extienden sin cortes, paredes de vidrio o laca sin juntas visibles. Perfección visual.",
    },
    {
      icon: "◎",
      title: "Iluminación integrada",
      desc: "LED integrado en perfiles de aluminio que ilumina sin revelar la fuente de luz. Atmósfera de lujo.",
    },
    {
      icon: "◈",
      title: "Líneas puras",
      desc: "Proporciones perfectas, esquinas en 90°, alineaciones milimétricas. La geometría como arte.",
    },
  ],
  ...
  gallery: [
    {
      ...
      alt: "Cocina estilo italiano blanca con líneas puras y sin manijas",
      label: "Blanco absoluto italiano",
    },
    {
      src: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80",
      alt: "Cocina italiana con isla y superficie continua de mármol",
      label: "Isla con mármol continuo",
    },
    {
      src: "https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&q=80",
      alt: "Cocina italiana oscura en gris grafito con iluminación LED",
      label: "Grafito con LED",
    },
    {
      src: "https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=800&q=80",
      alt: "Cocina italiana de alto brillo con gabinetes lacados",
      label: "Alto brillo italiano",
    },
    {
      src: "https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=800&q=80",
      alt: "Cocina italiana open concept con frentes sin manija",
      label: "Open concept sin manija",
    },
  ],
  ...
  waMessage:
    "Hola, me interesa una cocina estilo italiano. ¿Pueden mostrarme proyectos y cotizar el mío?",
};
